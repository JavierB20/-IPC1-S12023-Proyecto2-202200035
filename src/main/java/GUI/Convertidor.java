...
public class Convertidor extends javax.swing.JFrame {
    ...
    private void btnEjecutarParaleloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEjecutarParaleloActionPerformed
        ...
        AtomicInteger aumentar = new AtomicInteger(0);
        int inicio = 0;

        pbCantidadProcesada.setMinimum(0);
        pbCantidadProcesada.setMaximum(100);
        ...
        if(hilos.size() == 5) {
            ...
            public void run() {
                ...
                for (String nombreImagen : VariablesGlobales.lstImagenesNombre) {
                    ...
                    aumentar.addAndGet(inicioFinal);
